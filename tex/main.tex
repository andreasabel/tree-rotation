...
Checkmarks \agdaref{Main}{Amortization} are clickable and lead to the Agda formalization of the concept adjacent to the checkmark.  The formalization may contain extra detail that we chose to omit in the text to keep the presentation concise.
...
For uniformity, let us set $k_\tR = -1$ and refine move execution by the bank account \agdaref{MultiTreeGame}{RMoves}:
\[
...
and trees \agdaref{Tree}{Potential}:
\[
\begin{array}{lll}
